...
export const experiencesData = [
    ...
    },
    {
        ...
        description:
            "Dedicated 2026 to building high-scale applications. Focused on Advanced DevOps (Docker), Microservices architecture, and AI Integration.",
        icon: React.createElement(FaLaptopCode), // Icon mới
        score: "Self-Research",
        date: "2025 - Present",
    },
] as const;
...
export const projectsData = [
    {
        ...
        imageUrl: chatMee,
        url: "https://app-chatmee.onrender.com/",
    },
    {
        title: "Pern Store",
        description:
