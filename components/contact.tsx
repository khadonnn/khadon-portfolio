...
export default function Contact() {
    ...
    return (
        <motion.section
            id='contact'
            ref={ref}
            className='-mx-4 mb-20 sm:mb-28 w-full text-center relative overflow-hidden flex justify-center items-center min-h-[40rem] '
            initial={{
                opacity: 0,
            }}
            whileInView={{
        ...
        >
            ...
            <div className='w-[min(100%,38rem)] mx-auto z-10'>
