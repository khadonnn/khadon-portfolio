...
export default function ProjectsButton() {
    return (
        <a
            href='/projects'
            className='group relative isolate inline-flex items-center gap-2 overflow-hidden rounded-full bg-card/80 px-5 py-3 text-sm font-medium text-foreground/85 backdrop-blur-sm transition-all duration-300 hover:bg-muted/80 hover:text-foreground hover:shadow-[0_0_24px_rgba(15,23,42,0.08)] dark:hover:bg-white/5 dark:hover:shadow-[0_0_24px_rgba(34,211,238,0.18)]'
        >
