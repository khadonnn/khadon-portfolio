                ...
                <div className='mb-8 space-y-5'>
                    ...
                    <div className='flex items-center gap-4'>
                        <motion.span
                            ...
                            className='text-[0.6rem] font-medium uppercase tracking-[0.22em] text-black/30 dark:text-white/30'
                            style={{
                    ...
                    <motion.h2
                        ...
                        className='font-black text-black tracking-tighter leading-[0.88] dark:text-gray-50'
                        style={{
                            fontFamily: "Satoshi, system-ui, sans-serif",
                            fontWeight: 900,
